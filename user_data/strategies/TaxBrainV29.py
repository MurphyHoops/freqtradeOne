...
class TaxBrainV29(IStrategy):
    ...
    def custom_stake_amount(
        ...
        **kwargs,
        ...
        - ?? entry_tag ?? sl_pct / tp_pct / dir??? sl/tp ??????

        - ????? _pending_entry_meta / _last_signal?

        - ?? sizer.compute(...) ?????????

        - ?? reservation_id ?? _pending_entry_meta ? on_open_filled ???
        ...
        # 2) ???_pending_entry_meta / _last_signal
        ...
        **kwargs,
        ...
        reason = self.exit_policy.decide(
            ...
            pair, tid, float(
                ...
                current_profit) if current_profit is not None else None
